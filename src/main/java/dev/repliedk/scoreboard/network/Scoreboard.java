...
import dev.repliedk.scoreboard.map.Long2ObjectArrayMap;
import dev.repliedk.scoreboard.network.packet.RemoveObjectivePacket;
import dev.repliedk.scoreboard.network.packet.SetObjectivePacket;
import dev.repliedk.scoreboard.network.packet.SetScorePacket;
